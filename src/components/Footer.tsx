...
const socialLinks = [
  ...
  {
    href: "https://docs.google.com/forms/d/e/1FAIpQLSdIO8WA356T0NCfccMBD_a0Jw527zUBqYq75vVul-sNbOSDeg/viewform",
    label: "Website",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    href: "https://www.instagram.com/johann_emmanuel11/?__pwa=1",
    label: "Instagram",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
